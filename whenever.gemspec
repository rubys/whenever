...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/output_runner_test.rb", "test/output_at_test.rb", "test/command_line_test.rb", "test/cron_test.rb", "test/output_rake_test.rb", "test/output_env_test.rb", "test/test_helper.rb", "test/output_command_test.rb"]
